...
namespace Supabase.Postgrest
{
    ...
    public class IntRange : IEquatable<IntRange>
    {
        ...
        /// <param name="other">An object to compare with this object</param>
        public bool Equals(IntRange other) => other.Start.Equals(Start) && other.End.Equals(End);
        ...
        public static IntRange StartAt(Index start) => new IntRange(start, Index.End);

        /// <summary>Create a Range object starting from first element in the collection to the end Index.</summary>
        public static IntRange EndAt(Index end) => new IntRange(Index.Start, end);

        /// <summary>Create a Range object starting from first element to the end.</summary>
        public static IntRange All => new IntRange(Index.Start, Index.End);
